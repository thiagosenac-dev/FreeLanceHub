...
// Página de cadastro: só mostra o cabeçalho e o formulário de proposta vazio
export default function CadastroProposta(){
    return(
        <div className="space-y-6">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 bg-slate-950/80 backdrop-blur-xl border border-white/[0.08] p-6 rounded-2xl shadow-[0_8px_30px_-8px_rgba(3,10,28,0.8)]">
                <div className="space-y-1">
                    ...
                    <p className="text-sm text-slate-400">Preencha os dados para registrar uma nova Proposta</p>
                </div>
